...
# ============================================================================
# GRPO Ablation Baseline Script
# Parallel baseline to run_gppo.sh for fair comparison.
# ============================================================================
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-grpo_${TIMESTAMP}}"
...
project_name="${PROJECT_NAME:-GRPO-Ablation}"
adv_estimator="grpo"
...
# Classic GRPO sample-level aggregation.

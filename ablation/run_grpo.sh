...
# - Multiple rollouts per prompt (n=8)
# - Group-based advantage estimation (no critic model)
# - KL penalty in reward (optional) or as auxiliary loss
# ============================================================================
...
# --- 2. CORE PARAMETERS (GRPO Configuration) ---
...
# Classic GRPO: per-sequence token-mean aggregation.
...
n_resp_per_prompt=${N_RESP_PER_PROMPT:-8}  # GRPO typically uses multiple samples (e.g., 8)
...
# No critic max token len needed
